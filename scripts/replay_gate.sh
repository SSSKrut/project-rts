...
ai_vehicle_yield ai_vehicle_group ai_vehicle_convoy ai_march_line ai_march_slope \
ai_march_column ai_wall_glide ai_crowd_cross ai_vehicle_forest ai_vehicle_slope ai_vehicle_stuck ai_cover_side"}
