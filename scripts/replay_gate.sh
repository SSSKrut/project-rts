...
ai_air_transit ai_air_recon ai_solo_orders ai_air_aa_gun ai_air_manpads ai_air_cas lite_comms_range lite_comms_orders lite_comms_autonomy lite_comms_esm \
