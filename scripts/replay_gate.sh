...
ai_march_column ai_wall_glide ai_crowd_cross ai_vehicle_forest ai_vehicle_slope ai_vehicle_stuck ai_cover_side ai_shellfire ai_cover_trench ai_cover_hull ai_cover_defilade ai_cover_none ai_bounding ai_clear_building ai_focus_fire"}
