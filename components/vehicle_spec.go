...
var VehicleSpecs = [VehicleKindCount]VehicleSpec{
	VehicleTruck: {
		...
		SensorRangeM: 60, DetectMul: 1.6, NoiseRadiusM: 120,
	...
	VehicleBTR: {
		...
		SensorRangeM: 75, DetectMul: 1.5, NoiseRadiusM: 110,
	...
	VehicleBMP: {
		...
		SensorRangeM: 80, DetectMul: 1.5, NoiseRadiusM: 130,
		Class: ArmorClassLight, ReflexKind: VehicleReflexSmokeAndReverse,
	...
	VehicleTank: {
		...
		SensorRangeM: 90, DetectMul: 1.7, NoiseRadiusM: 150,
	...
	VehicleATCarrier: {
		...
		SensorRangeM: 85, DetectMul: 1.4, NoiseRadiusM: 100,
		Class: ArmorClassLight, ReflexKind: VehicleReflexSmokeAndReverse,
	...
	VehicleCommand: {
		...
		SensorRangeM: 80, DetectMul: 1.5, NoiseRadiusM: 100,
		Class: ArmorClassSoft, ReflexKind: VehicleReflexFlee,
