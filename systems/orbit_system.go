...
// OrbitInputEnabled gates mouse-driven camera orbit per frame. main.go
// sets true only when the 3D panel is focused so MMB-drag / wheel inside
// UI panels doesn't bleed into the 3D camera.
