...
### Phase 20 — Авиация: вертолёты и ПВО 🚧 M0 + M1 закрыты (план — `PHASE-20-AIR.md`)
...
**Майлстоуны.** M0 полёт ✅ → M1 обнаружение и излучение ✅ → **M2 ПВО** → M3 удар с воздуха → M4 транспорт и barrier'ы → M5 карта и внимание → M6 гигиена. Порядок кодирует правило «ПВО раньше удара»: играбельный срез — после M2, разведка с дилеммой излучения против ПВО, которая сама решает, светиться ли.
