...
### Phase 20 — Авиация: вертолёты и ПВО 📋 (план — `PHASE-20-AIR.md`)
...
- Обнаружение воздуха — **aircraft-major**, не seer-major; терраин-проба включается только на бреющем.
...
- `FireOnAir` (лежит без читателя с Phase 13) + множитель `VsAir` в `WeaponSpec`.
